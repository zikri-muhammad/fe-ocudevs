  ...
  return (
    <UserLayout>
          ...
          <div className="w-full h-full flex space-x-4 p-4">
            <div className="w-[60%] h-full flex flex-col space-y-4 justify-center">
              ...
              <div className="p-4 text-secondary-lighter">
                ...
                ab architecto rem! Delectus natus debitis est, repudiandae
                quidem cumque! Laborum amet, nisi natus dolorum facere quae
                quidem perferendis alias excepturi?
              </div>
              <div className=" p-4">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="text-secondary-light text-4xl font-semibold items-center flex justify-center pt-10">Education</div>
        <div className="text-secondary-lighter text-sm text-center max-w-sm pt-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quo eligendi, perspiciatis hic nemo cumque earum sequi dolor fugit unde autem soluta saepe repellendus, ut ducimus eveniet qui numquam architecto iure!</div>
      </div>
